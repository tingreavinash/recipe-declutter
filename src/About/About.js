...
function About() {
    ...
    return (
        ...
        <p>Simply enter the URL of a recipe page and let our application do the rest.</p>
        <p>It will extract the necessary details such as ingredients, instructions, and more.</p>
